...
# param_config = {
#         "attributes.analysis.wind_deficit_model.wake_expansion_coefficient.k_b": (0.022,0.022),
...
# # stacked.to_netcdf('results_stacked_hh_baseline.nc')
...
# stacked_h.to_netcdf('results_stacked_fullprofile_worst_sample.nc')
...
# stacked = xr.load_dataset('results_stacked_hh_baseline.nc')
...
ds_best_sample.to_netcdf('results_stacked_hh_worst_sample.nc')